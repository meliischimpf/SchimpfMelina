...
$codigo = $_POST['numero'];
  ...
  foreach ($productos as $data) {
    if (($data['codigo'] === $codigo) && ($data['codigo'] == "001") && ($data['pais_origen'] == "Argentina")) {
    ...
    } elseif (($data['codigo'] === $codigo) && ($data['codigo'] == "002") && ($data['pais_origen'] == "Argentina")) {
    ...
    } elseif (($data['codigo'] === $codigo) && ($data['codigo'] == "003") && ($data['pais_origen'] == "Argentina")) {
