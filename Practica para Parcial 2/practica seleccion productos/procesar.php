...
$productos = [
    ...
    if ($data['codigo'] == "001") {
        ...
        $cajaComida[] = $comida;
            ...
            if ($data['pais_origen'] == 'China') {
            $cajaChina[] = $comida;
            }

    } elseif ($data['codigo'] == "002") {
...
if (!empty($cajaChina)) {
    echo "Productos de origen chino:<br>";
    foreach ($cajaChina as $productoChina) {
        echo $productoChina->getInfoProducto() . "<br>";
    }
} else {
    echo "No hay productos de origen chino.<br>";
}
?>
